...
public class Ticket {
    ...
    public void setHasRead(boolean hasRead) {
        ...
        HelpTicket.database.Write(sql, (hasRead ? 1 : 0));
    }
    ...
    public String[] preformReplace(String replacer) {
        replacer = replacer
                ...
                .replaceAll("%ticketAssigneeName", Matcher.quoteReplacement(this.getUnformattedAssignee()))
                .replaceAll("%ticketAssigneeFull", Matcher.quoteReplacement(this.getAssignee()))
                .replaceAll("%ticketLongMessage", Matcher.quoteReplacement(this.getInfo()))
                .replaceAll("%ticketShortMessage", Matcher.quoteReplacement(this.getShortInfo()))
                .replaceAll("%ticketStatus", this.getStatus())
                .replaceAll(
                        "%ticketNumberComments",
                        (log.isEmpty() ? HelpTicket.plugin.language.getTicketCommentNumberFormatNone() : (log.size() == 1 ? HelpTicket.plugin.language.getTicketCommentNumberFormatSingle().replaceAll("%num", log.size() + "") : HelpTicket.plugin.language.getTicketCommentNumberFormatPlural()
                                .replaceAll("%num", log.size() + "")))).replaceAll("%ticketWorld", this.getWorld());
                ...
                if (i == 0) {
                    if (this.getLog().size() >= 1) {
                        for (String[] s : this.getLog()) {
                            ticketComments[i] += HelpTicket.plugin.language.getTicketFullInfoCommentMessage().replaceAll("%ticketCommentOwner", Matcher.quoteReplacement(s[0])).replaceAll("%ticketCommentMessage", Matcher.quoteReplacement(s[1])) + "%newline";
                        }
                    } else {
