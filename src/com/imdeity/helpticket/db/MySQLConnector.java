...
public class MySQLConnector {
	...
	public MySQLConnector() {
		...
		// make the connection
		try {
			conn = DriverManager.getConnection("jdbc:mysql://" + HelpTicket.plugin.config.getMySQLServerAddress() + ":" + HelpTicket.plugin.config.getMySQLServerPort() + "/" + HelpTicket.plugin.config.getMySQLDatabaseName() + "?user=" + HelpTicket.plugin.config.getMySQLDatabaseUsername() + "&password=" + HelpTicket.plugin.config.getMySQLDatabasePassword());
